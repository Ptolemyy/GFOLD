...
extern void cpg_update_r0(cpg_int idx, cpg_float val);
extern void cpg_update_v0(cpg_int idx, cpg_float val);
extern void cpg_update_log_m0(cpg_float val);
extern void cpg_update_rp3(cpg_int idx, cpg_float val);
extern void cpg_update_dt(cpg_float val);
extern void cpg_update_dt_squared(cpg_float val);
extern void cpg_update_g_dt_sq(cpg_int idx, cpg_float val);
extern void cpg_update_g_dt(cpg_int idx, cpg_float val);
extern void cpg_update_a_dt(cpg_float val);
extern void cpg_update_sin_y_gs(cpg_float val);
extern void cpg_update_cos_theta_deg(cpg_float val);
extern void cpg_update_z0(cpg_int idx, cpg_float val);
extern void cpg_update_mu_1(cpg_int idx, cpg_float val);
extern void cpg_update_mu_2(cpg_int idx, cpg_float val);
